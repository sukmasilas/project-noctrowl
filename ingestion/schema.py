...
review_queue = Table(
    ...
    # 'contract_labor' added 2026-09-05 — the new CONTRACT_LABOR operating
    # expense account (outside IT contractor paid per-listing to create
    # eBay listings, see ledger/chart_of_accounts.py) needs its own
